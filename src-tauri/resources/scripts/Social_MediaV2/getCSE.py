...
def get_cse_parameters(platform=None, use_tor=False):
    ...
    platform_urls = {
        ...
        "youtube": "https://www.social-searcher.com/youtubecse.html?q=test&sort=date",
        "reddit": "https://www.social-searcher.com/redditcse.html?q=test&sort=date",
        "snapchat": "https://www.social-searcher.com/snapchatcse.html?q=test&sort=date"
    }
